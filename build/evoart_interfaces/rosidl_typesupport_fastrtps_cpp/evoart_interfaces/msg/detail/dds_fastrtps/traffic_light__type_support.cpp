...
#include "evoart_interfaces/msg/detail/traffic_light__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = evoart_interfaces::msg::TrafficLight;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const evoart_interfaces::msg::TrafficLight *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<evoart_interfaces::msg::TrafficLight *>(
    untyped_ros_message);
...
{
  return &evoart_interfaces::msg::typesupport_fastrtps_cpp::_TrafficLight__handle;
}
