...
bool evoart_interfaces__msg__vehicle_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("evoart_interfaces.msg._vehicle_control.VehicleControl", full_classname_dest, 53) == 0);
  }
  evoart_interfaces__msg__VehicleControl * ros_message = _ros_message;
  {  // target_velocity
...
PyObject * evoart_interfaces__msg__vehicle_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("evoart_interfaces.msg._vehicle_control");
