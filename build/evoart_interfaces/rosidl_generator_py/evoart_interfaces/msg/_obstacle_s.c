...
bool evoart_interfaces__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("evoart_interfaces.msg._obstacle.Obstacle", full_classname_dest, 40) == 0);
  }
  evoart_interfaces__msg__Obstacle * ros_message = _ros_message;
  {  // obstacle_type
...
PyObject * evoart_interfaces__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("evoart_interfaces.msg._obstacle");
