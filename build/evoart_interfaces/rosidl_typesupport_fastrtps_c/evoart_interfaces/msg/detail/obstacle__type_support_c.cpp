...
#include "evoart_interfaces/msg/detail/obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _Obstacle__ros_msg_type = evoart_interfaces__msg__Obstacle;
...
size_t get_serialized_size_evoart_interfaces__msg__Obstacle(
  const void * untyped_ros_message,
...
static uint32_t _Obstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_evoart_interfaces__msg__Obstacle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_evoart_interfaces
size_t max_serialized_size_evoart_interfaces__msg__Obstacle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = evoart_interfaces__msg__Obstacle;
    is_plain =
      (
...
static size_t _Obstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_evoart_interfaces__msg__Obstacle(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, evoart_interfaces, msg, Obstacle)() {
