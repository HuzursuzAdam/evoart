...
{
  new (message_memory) evoart_interfaces::msg::Obstacle(_init);
}

void Obstacle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<evoart_interfaces::msg::Obstacle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Obstacle_message_member_array[3] = {
  {
    ...
    offsetof(evoart_interfaces::msg::Obstacle, obstacle_type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evoart_interfaces::msg::Obstacle, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evoart_interfaces::msg::Obstacle, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Obstacle_message_members = {
  ...
  3,  // number of fields
  sizeof(evoart_interfaces::msg::Obstacle),
...
get_message_type_support_handle<evoart_interfaces::msg::Obstacle>()
{
  return &::evoart_interfaces::msg::rosidl_typesupport_introspection_cpp::Obstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, evoart_interfaces, msg, Obstacle)() {
  return &::evoart_interfaces::msg::rosidl_typesupport_introspection_cpp::Obstacle_message_type_support_handle;
}
