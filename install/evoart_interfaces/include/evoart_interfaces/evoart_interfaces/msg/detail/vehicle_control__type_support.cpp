...
{
  new (message_memory) evoart_interfaces::msg::VehicleControl(_init);
}

void VehicleControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<evoart_interfaces::msg::VehicleControl *>(message_memory);
  typed_message->~VehicleControl();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleControl_message_member_array[3] = {
  {
    ...
    offsetof(evoart_interfaces::msg::VehicleControl, target_velocity),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evoart_interfaces::msg::VehicleControl, steering_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evoart_interfaces::msg::VehicleControl, emergency_stop),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleControl_message_members = {
  ...
  3,  // number of fields
  sizeof(evoart_interfaces::msg::VehicleControl),
...
{
  return &::evoart_interfaces::msg::rosidl_typesupport_introspection_cpp::VehicleControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, evoart_interfaces, msg, VehicleControl)() {
  return &::evoart_interfaces::msg::rosidl_typesupport_introspection_cpp::VehicleControl_message_type_support_handle;
}
